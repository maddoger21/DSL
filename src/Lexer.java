...
public class Lexer {
    ...
    public LinkedList<Token> analyse() {
        // в этом цикле находим все токены
        while (nextToken()) {}
        //выводим все токены, кроме точки с запятой
    ...
    public boolean nextToken() {
        ...
        //если вышли за границу, то заканчиваем поиск токенов
        ...
        //если не нашли подходящий токен
