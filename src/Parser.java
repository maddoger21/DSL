...
public class Parser {
    ...
    int tokenPosition = 0;
//Создается Парсер со списком токенов
    public Parser(LinkedList<Token> tokens) {
        this.tokens = tokens;
    }
//метод, возвращающий токен по имени, либо возвращает нул
...
//метод, который проверяет наличие нужного токена
...
//метод для парсинга отдельных строк кода(те что заканчиваются точкой с запятой)
